...
INSERT INTO liga.employee ( id,  fio,  gender,  department_id,  degree,  position,  birthday)
VALUES(7, 'Караваев Владимир Александрович', 'MALE', 2, 'Ph.D','Lecturer', to_timestamp('1983-06-15', 'yyyy-mm-dd'));
...
INSERT INTO liga.employee ( id,  fio,  gender,  department_id,  degree,  position,  birthday)
VALUES(10, 'Гутнова Евгения Владимировна', 'FEMALE', 3, 'Ph.D','Lecturer', to_timestamp('1969-10-23', 'yyyy-mm-dd'));

INSERT INTO liga.employee ( id,  fio,  gender,  department_id,  degree,  position,  birthday)
VALUES(11, 'Дыбо Анна Владимировна', 'FEMALE', 3, 'Ph.D','Lecturer', to_timestamp('1978-07-10', 'yyyy-mm-dd'));
