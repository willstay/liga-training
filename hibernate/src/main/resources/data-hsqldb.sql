-- department
INSERT INTO liga.department (title,  address, foundation_year)
...
VALUES('Владимир Николаевич Чубариков', 'MALE', 1, 'Доктор наук','Dean', to_date('1951-09-05', 'YYYY-MM-DD'));

INSERT INTO liga.employee (  fio,  gender,  department_id,  degree,  position,  birthday)
VALUES('Сысоев Николай Николаевич', 'MALE', 2, 'Доктор наук','Dean', to_date('1949-11-15', 'YYYY-MM-DD'));

INSERT INTO liga.employee (  fio,  gender,  department_id,  degree,  position,  birthday)
VALUES('Тучков Иван Иванович', 'MALE', 3, 'Доктор наук','Dean', to_date('1956-09-13', 'YYYY-MM-DD'));


INSERT INTO liga.employee (  fio,  gender,  department_id,  degree,  position,  birthday)
VALUES('Комбаров Анатолий Петрович', 'MALE', 1, 'Доктор наук','Professor', to_date('1967-03-05', 'YYYY-MM-DD'));

INSERT INTO liga.employee (  fio,  gender,  department_id,  degree,  position,  birthday)
VALUES('Корнев Андрей Алексеевич', 'MALE', 1, 'Доктор наук','Lecturer', to_date('1971-08-13', 'YYYY-MM-DD'));

INSERT INTO liga.employee (  fio,  gender,  department_id,  degree,  position,  birthday)
VALUES('Штерн Александр Исаакович', 'MALE', 1, 'Доктор наук','Professor', to_date('1948-06-05', 'YYYY-MM-DD'));


INSERT INTO liga.employee (  fio,  gender,  department_id,  degree,  position,  birthday)
VALUES('Караваев Владимир Александрович', 'MALE', 2, 'Кандидат наук','Lecturer', to_date('1983-06-15', 'YYYY-MM-DD'));

INSERT INTO liga.employee (  fio,  gender,  department_id,  degree,  position,  birthday)
VALUES('Тверской Василий Борисович ', 'MALE', 2, 'Доктор наук','Professor', to_date('1967-02-28', 'YYYY-MM-DD'));

INSERT INTO liga.employee (  fio,  gender,  department_id,  degree,  position,  birthday)
VALUES('Соколов Владимир Андреевич', 'MALE', 2, 'Кандидат наук','Lecturer', to_date('1975-08-07', 'YYYY-MM-DD'));


INSERT INTO liga.employee (  fio,  gender,  department_id,  degree,  position,  birthday)
VALUES('Гутнова Евгения Владимировна', 'FEMALE', 3, 'Доктор наук','Professor', to_date('1969-10-23', 'YYYY-MM-DD'));

INSERT INTO liga.employee (  fio,  gender,  department_id,  degree,  position,  birthday)
VALUES('Дыбо Анна Владимировна', 'FEMALE', 3, 'Кандидат наук','Lecturer', to_date('1978-07-10', 'YYYY-MM-DD'));



INSERT INTO liga.employee (fio,  gender,  department_id,  degree,  position,  birthday)
VALUES('Соколов Владимир Андреевич', 'MALE', 2, 'BACHELOR','Secretary', to_date('1975-08-07', 'YYYY-MM-DD'));
INSERT INTO liga.employee (fio,  gender,  department_id,  degree,  position,  birthday)
VALUES('Гутнова Евгения Владимировна', 'FEMALE', 3, 'MASTER','Secretary', to_date('1969-10-23', 'YYYY-MM-DD'));
INSERT INTO liga.employee (fio,  gender,  department_id,  degree,  position,  birthday)
VALUES('Дыбо Анна Владимировна', 'FEMALE', 3, 'BACHELOR','Secretary', to_date('1978-07-10', 'YYYY-MM-DD'));

-- liga.student

--liquibase formatted sql logicalFilePath:V1_009_liga.student_DATA.sql
